   ...
   <div class="well">
      ...
      <fieldset>
         ...
         <div class="form-group">
            ...
            <div class="col-lg-10"><?php echo form_input($identity, null, 'class="form-control"');?></div>
         </div>
         <div class="form-group">
            <label for="input" class="col-lg-2 col-lg-offset-2">
            <?php echo form_submit('submit', lang('forgot_password_submit_btn'), 'class="btn-primary btn-sm"');?>
            </label>
            <a href="<?php echo site_url('main');?>"><button type="button" class="btn btn-lg btn-link">Home</button></a>
         </div>
      </fieldset>
      <?php echo form_close();?>
   </div>
